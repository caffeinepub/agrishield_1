...
import type { ScanRecord as _ScanRecord, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addScanRecord(arg0: ScanRecord): Promise<ScanRecord> {
        if (this.processError) {
            try {
                const result = await this.actor.addScanRecord(to_candid_ScanRecord_n1(this._uploadFile, this._downloadFile, arg0));
                return from_candid_ScanRecord_n4(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
...
function from_candid_ScanRecord_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ScanRecord): ScanRecord {
...
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        diseaseDetected: value.diseaseDetected,
        plantName: value.plantName,
        treatmentRecommendation: value.treatmentRecommendation,
        imageRef: value.imageRef,
        severity: from_candid_variant_n6(_uploadFile, _downloadFile, value.severity),
...
function from_candid_vec_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_ScanRecord>): Array<ScanRecord> {
    return value.map((x)=>from_candid_ScanRecord_n4(_uploadFile, _downloadFile, x));
}
function to_candid_ScanRecord_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ScanRecord): _ScanRecord {
...
function to_candid_record_n2(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        treatmentRecommendation: value.treatmentRecommendation,
        imageRef: value.imageRef,
        severity: to_candid_variant_n3(_uploadFile, _downloadFile, value.severity),
        preventionTips: value.preventionTips
    };
}
function to_candid_variant_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Variant_low_high_medium): {
    low: null;
} | {
    high: null;
} | {
